...
const EmployeeEngagementForm: React.FC = () => {
  ...
  const calculateHealthMetrics = ({
    ...
    Alert.alert(
      ...
      `Hello ${name} (${mobile}),\n\nYour BMI: ${bmi.toFixed(
        2
      )}\nRecommended Water Intake: ${waterIntake.toFixed(2)} L/day`
    );
  };
          ...
          {({
            ...
            <View style={styles.formWrapper}>
              ...
              {/* <View style={styles.stepperSection}>
                ...
                {touched.remainder && errors.remainder && (
                  <Text style={styles.error}>{errors.remainder}</Text>
                )}
              </View>
              ...
              <View style={styles.triggerTypeWrapper}>
                      ...
                      >
                        <Text
                          style={[
                            ...
                            values.triggerType === val &&
                              styles.triggerButtonTextSelected,
                          ]}
                        >
                          {key}
                        </Text>
                ...
                {touched.triggerType && errors.triggerType && (
                  <Text style={styles.error}>{errors.triggerType}</Text>
                )}
              </View> */}
              <TouchableOpacity
                style={styles.button}
